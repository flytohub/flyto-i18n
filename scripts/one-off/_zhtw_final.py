...
ZH = {
    ...
    # landing pages
    "landing.about.faq.answer1": "Flyto2 是一個開源自動化平台，可在伺服器、桌面和物聯網裝置上執行工作流程。",
    "landing.about.faq.answer2": "是的，Flyto2 完全免費且開源，採用 MIT 授權。",
    "landing.about.faq.answer3": "Flyto2 支援 Node.js 和 WebAssembly 執行環境。",
    "landing.about.faq.answer4": "支援 Windows、macOS 和 Linux，以及 Docker 容器。",
    "landing.about.faq.question1": "什麼是 Flyto2？",
    "landing.about.faq.question2": "Flyto2 是免費的嗎？",
    "landing.about.faq.question3": "Flyto2 支援哪些程式語言？",
    "landing.about.faq.question4": "Flyto2 支援哪些平台？",
