...
| function | `_flatten` | [`tests/test_space_operations_orphan_keys.py:24`](../../tests/test_space_operations_orphan_keys.py#L24) | Flatten a generated nested translation object. |
| function | `_catalogs` | [`tests/test_space_operations_orphan_keys.py:36`](../../tests/test_space_operations_orphan_keys.py#L36) | Load every Cloud source catalog for one locale. |
| function | `_cloud_dist` | [`tests/test_space_operations_orphan_keys.py:46`](../../tests/test_space_operations_orphan_keys.py#L46) | Load one generated Cloud bundle as a flat map. |
| function | `test_operations_runtime_keys_have_reviewed_unique_source_ownership` | [`tests/test_space_operations_orphan_keys.py:52`](../../tests/test_space_operations_orphan_keys.py#L52) | Keep runtime labels reviewed and owned only by Space Operations. |
| function | `test_operations_runtime_keys_match_generated_cloud_bundles` | [`tests/test_space_operations_orphan_keys.py:62`](../../tests/test_space_operations_orphan_keys.py#L62) | Publish the exact reviewed values in generated Cloud bundles. |
