...
| function | `_flatten` | [`tests/test_space_operations_orphan_keys.py:36`](../../tests/test_space_operations_orphan_keys.py#L36) | Flatten a generated nested translation object. |
| function | `_catalogs` | [`tests/test_space_operations_orphan_keys.py:48`](../../tests/test_space_operations_orphan_keys.py#L48) | Load every Cloud source catalog for one locale. |
| function | `_cloud_dist` | [`tests/test_space_operations_orphan_keys.py:58`](../../tests/test_space_operations_orphan_keys.py#L58) | Load one generated Cloud bundle as a flat map. |
| function | `test_operations_runtime_keys_have_reviewed_unique_source_ownership` | [`tests/test_space_operations_orphan_keys.py:64`](../../tests/test_space_operations_orphan_keys.py#L64) | Keep runtime labels reviewed and owned by one canonical catalog. |
| function | `test_operations_runtime_keys_match_generated_cloud_bundles` | [`tests/test_space_operations_orphan_keys.py:74`](../../tests/test_space_operations_orphan_keys.py#L74) | Publish the exact reviewed values in generated Cloud bundles. |
