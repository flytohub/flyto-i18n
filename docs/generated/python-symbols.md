...
| class | `CodeUIKeyContractTests` | [`tests/test_code_ui_keys.py:19`](../../tests/test_code_ui_keys.py#L19) | Keep release-critical Code copy present in primary supported locales. |
| method | `CodeUIKeyContractTests.test_primary_locales_publish_reviewed_code_ui_copy` | [`tests/test_code_ui_keys.py:22`](../../tests/test_code_ui_keys.py#L22) | Require reviewed, non-empty UI copy for each primary locale. |
