...
| class | `CodeUIKeyContractTests` | [`tests/test_code_ui_keys.py:21`](../../tests/test_code_ui_keys.py#L21) | Keep release-critical Code copy present in primary supported locales. |
| method | `CodeUIKeyContractTests.test_primary_locales_publish_reviewed_code_ui_copy` | [`tests/test_code_ui_keys.py:24`](../../tests/test_code_ui_keys.py#L24) | Require reviewed, non-empty UI copy for each primary locale. |
| method | `CodeUIKeyContractTests.test_local_admin_password_copy_matches_runtime_policy` | [`tests/test_code_ui_keys.py:39`](../../tests/test_code_ui_keys.py#L39) | Keep registration copy aligned with the 8-character/72-byte policy. |
