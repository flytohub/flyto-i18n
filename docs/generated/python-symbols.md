...
| function | `_flatten` | [`tests/test_space_operations_orphan_keys.py:44`](../../tests/test_space_operations_orphan_keys.py#L44) | Flatten a generated nested translation object. |
| function | `_catalogs` | [`tests/test_space_operations_orphan_keys.py:56`](../../tests/test_space_operations_orphan_keys.py#L56) | Load every Cloud source catalog for one locale. |
| function | `_cloud_dist` | [`tests/test_space_operations_orphan_keys.py:66`](../../tests/test_space_operations_orphan_keys.py#L66) | Load one generated Cloud bundle as a flat map. |
| function | `test_operations_runtime_keys_have_reviewed_unique_source_ownership` | [`tests/test_space_operations_orphan_keys.py:72`](../../tests/test_space_operations_orphan_keys.py#L72) | Keep runtime labels reviewed and owned by one canonical catalog. |
| function | `test_operations_runtime_keys_match_generated_cloud_bundles` | [`tests/test_space_operations_orphan_keys.py:82`](../../tests/test_space_operations_orphan_keys.py#L82) | Publish the exact reviewed values in generated Cloud bundles. |
