...
| function | `_flatten` | [`tests/test_ai_space_runner_binding_catalog.py:92`](../../tests/test_ai_space_runner_binding_catalog.py#L92) | Flatten one generated nested translation object. |
| function | `_source_catalog` | [`tests/test_ai_space_runner_binding_catalog.py:104`](../../tests/test_ai_space_runner_binding_catalog.py#L104) | Load the source-owned AI Space catalog for one locale. |
| function | `_source_owners` | [`tests/test_ai_space_runner_binding_catalog.py:110`](../../tests/test_ai_space_runner_binding_catalog.py#L110) | Return each Cloud source catalog that declares one key. |
| function | `_dist` | [`tests/test_ai_space_runner_binding_catalog.py:120`](../../tests/test_ai_space_runner_binding_catalog.py#L120) | Load one generated distribution bundle as a flat key map. |
| function | `_placeholders` | [`tests/test_ai_space_runner_binding_catalog.py:126`](../../tests/test_ai_space_runner_binding_catalog.py#L126) | Return the interpolation placeholders declared by one value. |
| function | `test_runner_binding_contract_has_exact_additive_key_set` | [`tests/test_ai_space_runner_binding_catalog.py:131`](../../tests/test_ai_space_runner_binding_catalog.py#L131) | Pin every new placement, dispatch, and save-state key. |
| function | `test_runner_binding_copy_is_reviewed_nonempty_and_uniquely_owned` | [`tests/test_ai_space_runner_binding_catalog.py:153`](../../tests/test_ai_space_runner_binding_catalog.py#L153) | Keep visible copy reviewed, non-empty, and owned by AI Space. |
| function | `test_runner_binding_placeholder_parity_and_existing_elsewhere_copy` | [`tests/test_ai_space_runner_binding_catalog.py:163`](../../tests/test_ai_space_runner_binding_catalog.py#L163) | Preserve placeholder parity and the prior remote-machine count label. |
| function | `test_runner_binding_source_matches_cloud_and_aggregate_dist` | [`tests/test_ai_space_runner_binding_catalog.py:173`](../../tests/test_ai_space_runner_binding_catalog.py#L173) | Publish identical copy in Cloud and aggregate distributions. |
...
| function | `test_source_readiness_and_existing_api_labels_are_reviewed_and_bundled` | [`tests/test_local_cli_settings_copy.py:23`](../../tests/test_local_cli_settings_copy.py#L23) | Pin complete reviewed settings copy in each shipped baseline locale. |
